...
# %%
TOPICS = ["energie"] #["cannabis", "kinder", "energie"]
...
for topic in TOPICS:  # ----------------------------------------------------------------------
    ...
    for strategie in STRATEGIES:  # -------------------------------------------------------------
        ...
        dataset.save_to_disk(
            f"../../data/tmp/processed_dataset_{topic}_buffed_chunkified_{strategie}{SUFFIX}_{MAX_CONTENT_LENGTH}_sampling_{MODEL.split('/')[1]}_{FEATURES}_{SPLIT}")
